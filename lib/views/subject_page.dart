...
import 'package:courser/views/lesson_page.dart';
  ...
  Widget buildAbout() {
    return Center(
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          return Text(allSubjects!.lessons[index].lessonData.description, textAlign: TextAlign.center);
        },
      ),
    );
  }
...
class Web extends StatefulWidget {
  const Web({Key? key, required this.title, required this.imgUrl}) : super(key: key);
  final String imgUrl;
  final String? title;
  @override
